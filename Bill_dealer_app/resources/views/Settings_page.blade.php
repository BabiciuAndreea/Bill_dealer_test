        ...
        <div class="container ">
            <div class=" rounded-lg d-block d-sm-flex settings_container">
                <div class="profile-tab-nav border-right profile_tab">
                    ...
                    <div class="text_nav nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                        aria-orientation="vertical">
                        <a class="text_part nav-link active" id="account-tab" data-toggle="pill" href="#account"
                            role="tab" aria-controls="account" aria-selected="true" style="color:white;">
                        ...
                        <a class="nav-link" id="security-tab" data-toggle="pill" href="#security" role="tab"
                            aria-controls="security" aria-selected="false"style="color:white;">
                            <i class="fa fa-user text-center mr-1"style="color:white;"></i>
                            Security
                        </a>
                        <a class="nav-link" id="application-tab" data-toggle="pill" href="#application" role="tab"
                            aria-controls="application" aria-selected="false"style="color:white;">
                        ...
                        <a class="nav-link" id="notification-tab" data-toggle="pill" href="#notification" role="tab"
                            aria-controls="notification" aria-selected="false"style="color:white;">
                            <i class="fa fa-bell text-center mr-1"style="color:white;"></i>
                            Notification
                        </a>
                        <a class="nav-link" id="notification-tab" data-toggle="pill" href="#settings" role="tab"
                            aria-controls="notification" aria-selected="false"style="color:white;">
                            <i class="fa fa-sliders text-center mr-1"style="color:white;"></i>
                            Edit Page
                        </a>
                    </div>
                </div>
			...
			<div class=" srounded-lg d-block d-sm-flex settings_container">
				<div class="profile-tab-nav border-right profile_tab">
					<div class="p-4">
						...
						<h4 class="text-center " style="color:white">{{Auth::user()->last_name}} {{Auth::user()->first_name}}</h4>
					</div>
