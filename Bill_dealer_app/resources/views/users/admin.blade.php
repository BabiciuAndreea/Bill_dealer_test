...
@section('content')
    <div class="container-fluid py-0 px-0 mx-0">
        <div class="row flex-nowrap">
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 mx-0 background ">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-1 pt-2 text-white min-vh-100">
                                ...
                                <ul class="dropdown-menu mx-5">
                                    <div class="row mx-3">
                                        ...
                                        <div class="col-4"> 
                                            ...
                                            <li><a class="dropdown-item" href="#">Collected amounts <br>per customer</a></li>
                                        ...
                                        <div class="col-4 ">
                                            ...
                                            <li><a class="dropdown-item" href="#">Extracted imports and register</a></li>
                                        </div>
                                </ul>
                            </div>
                        </li>
                    ...
                    <div class="dropdown pb-5">
                        ...
                        <ul class="dropdown-menu account text-small shadow" aria-labelledby="dropdownUser1">
                            ...
                            <li><button type="submit" class="dropdown-item">Sign out</></li>
                        </ul>
                    </div>
                </form>
                </div>
            ...
            <div class="col py-3">
                Continut - se modifica la fiecare blade corespunzator butoanelor
            </div>
        </div>
    </div>
@endsection
