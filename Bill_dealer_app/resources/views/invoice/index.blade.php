                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('invoices.destroy', $invoice->id) }}" method="POST">
                                    ...
                                    <button type="submit" disabled class="btn btn-xs btn-danger btn-flat show-alert-delete-box btn-sm" data-toggle="tooltip" title='Delete'>Delete</button>
                                    <!-- <button type="submit" class="btn btn-sm btn-danger">Delete</button> -->
                                </form>
                                @else
                                <form action="{{ route('invoices.destroy', $invoice->id) }}" method="POST">
                                    <a class="btn-sm edit-buttons" href="{{ route('invoices.edit', $invoice->id) }}">Edit</a>
                                ...
                                <a href="{{ route('pdf', $invoice->id) }}"> <i class="bi bi-file-earmark-pdf"></i></a>
                                @else
                                    <a href="#"></a>
