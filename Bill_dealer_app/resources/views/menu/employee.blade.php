                ...
                <div class="table-wrapper px-0 mx-0 py-0 px-0">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><img src="{{ 'storage/' . $employee->avatar }}" alt="hugenerd" width="30" height="30" class="rounded-circle"></td>
                                ...
                                <td>
                                    <form action="{{ route('employees.destroy', $employee->id) }}" method="POST">
                                        <a href="{{ route('employees.edit', $employee->id)}}" class="btn btn-sm"> <span class="py-1 px-1">Edit</span></a>
                                        @csrf
                                        @method('DELETE')
                    ...
                    <div class="modal-content px-5 py-3">
                        <form action="{{ route('employees.update', $employee->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ $employee->first_name }}" required autocomplete="first_name" autofocus placeholder="First Name">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ $employee->last_name }}" required autocomplete="last_name" autofocus placeholder="Last Name">
                            ...
                            <div class="form-outline">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $employee->email }}" required autocomplete="email" placeholder="Email">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="form-outline">
                                    <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $employee->address }}" required autocomplete="address" placeholder="Address">
                            ...
                            <div class="row">
                                <div class="col-md-5 mb-4">
                                    <div class="form-outline">
                                        <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $employee->phone }}" required autocomplete="phone" placeholder="Phone">
                                ...
                                <div class="col-md-7 mb-4">
                                    <div class="form-outline">
                                        <input id="cnp" type="text" class="form-control @error('cnp') is-invalid @enderror" name="cnp" value="{{ $employee->cnp }}" required autocomplete="cnp" placeholder="CNP">
