                    ...
                    <div class="card-body text-start">
                        ...
                        <form action="/action_page.php" class="was-validated" method="POST">
                            <div class="form-outline">
                                <input type="text" id="company_name" class="form-control form-control-md"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <input type="text" id="cif" class="form-control form-control-md"
                                            placeholder="TIN (CIF ro)" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <input type="text" id="company_id" class="form-control form-control-md"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <input type="text" id="city" class="form-control form-control-md"
                                            placeholder="City" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <input type="county" id="password_confirm" class="form-control form-control-md"
                                            placeholder="County" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="caen" class="form-control form-control-md"
                                            placeholder="Caen" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="capital" class="form-control form-control-md"
                            ...
                            <BR>
                            <div class="form-outline">
                                <input type="text" id="iban" class="form-control form-control-md"
                                    placeholder="IBAN" />
                            </div>
                            <br>
                                ...
                                <div class="col justify-content-center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="form2Example31"
                                            checked />
                                        <label class="form-check-label text-muted" for="form2Example31"> Agree with <a
