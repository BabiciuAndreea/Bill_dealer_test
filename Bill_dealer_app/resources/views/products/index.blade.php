...
<body>
    ...
    <div class="tab-content mt-5 mx-0 text-center" id="v-pills-tabContent">
        <div class="tab-pane fade show active px-4 py-0 my-0 mx-4" id="company" role="tabpanel" aria-labelledby="employee-tab">
            <div class="container text-size mx-5">
                <div class="row mx-5 mt-5">
                    <div class="col-lg-12">
                        ...
                        <div class="pull-right">
                            <a href="#addProductModal" class="btn add-button " data-toggle="modal"> <i class="bi bi-person-plus"></i> <span class="py-1 px-1">Add product</span></a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-striped table-hover mx-5 mt-2">
                    <thead>
                        <tr>
                            <th class="px-2">ID</th>
