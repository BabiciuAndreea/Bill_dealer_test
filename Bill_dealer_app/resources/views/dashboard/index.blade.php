                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                ...
                                <a href="{{ route('unpaid_invoices_pdf') }}" class="btn btn-secondary btn-sm" title= "Download PDF">
                                    <i class="fas fa-download"></i>
                                </a>
                                <a href="{{ route('excel_invoice') }}" target="_blank" class="btn btn-secondary btn-sm" title= "Download Excel">
                ...
                <div class="card">
                    <div class="card-header border-0">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('produs_pdf') }}" class="btn btn-secondary btn-sm" title= "Download PDF">
                                <i class="fas fa-download"></i>
                            </a>
                            <a href="{{ route('excel') }}" target="_blank" class="btn btn-secondary btn-sm" title= "Download Excel">
                                <i class="fa-regular fa-file-excel"></i>
                            </a>
                        </div>
                    </div>
