                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="pull-right">
                            <a href="#addProductModal" class="btn add-button my-3" data-toggle="modal"> <i class="bi bi-person-plus"></i> <span class="py-1 px-1">Add client</span></a>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach ($clients as $client)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('contact_create', $client->id) }}"> <i class="bi bi-person-plus mx-2"></i></a>

                                <a href="{{ route('contact.index', $client->id) }}"> <i class="bi bi-list"></i></a>
                            </td>
                            <td>
                                <form action="{{ route('client.destroy', $client->id) }}" method="POST">
                                    <a class="btn-sm edit-buttons" href="{{ route('client.edit', $client->id) }}">Edit</a>
                        ...
                        <div class="modal-content px-5 py-5">
                            <form method="POST" action="{{ route('client.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-outline">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="client_name" required autocomplete="client_name" autofocus placeholder="Client name">
                                ...
                                <br>
                                <div class="form-outline">
                                    <input id="cif" type="text" class="form-control @error('cif') is-invalid @enderror" name="cif" required autocomplete="cif" autofocus placeholder="Cif">
                                ...
                                <br>
                                <div class="form-outline">
                                    <input id="nr_reg" type="text" class="form-control @error('nr_reg') is-invalid @enderror" name="nr_reg" required autocomplete="nr_reg" placeholder="Trade register">
                                ...
                                <div class="form-outline">
                                    <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" required autocomplete="city" placeholder="City">
                                ...
                                <div class="form-outline">
                                    <input id="county" type="text" class="form-control" name="county" required autocomplete="county" placeholder="County">
                                </div>
                                <br>
                                <div class="form-outline">
                                ...
                                <br>
                                <div class="form-outline">
                                    <input id="phone" type="text" class="form-control" name="phone" required autocomplete="phone" placeholder="Phone">
                                </div>
                                <br>
                                <div class="form-outline">
                                    <input id="email" type="text" class="form-control" name="email" required autocomplete="email" placeholder="Email">
                                </div>
