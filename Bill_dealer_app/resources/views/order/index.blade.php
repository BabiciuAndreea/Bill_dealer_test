            ...
            <div class="container">
                <form action="{{ route('order') }}" method="GET">
                    ...
                    <div class="row text-start">
                        <select id="list" name="list" class="form-select ms-3 products-select"
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary mt-3" name="add_product">Add</button>
                                ...
                                <td>
                                    <div class="form-outline">
                                        <input id="order_quantity" type="text"
                                            ...
                                            autocomplete="order_quantity" placeholder="">
                                    </div>
                                </td>
                                <td>
